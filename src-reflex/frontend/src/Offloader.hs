...
-- The request needs to be XHR, either make it work with:
-- https://hackage.haskell.org/package/reflex-dom-0.3/candidate/docs/Reflex-Dom-Xhr.html
-- or take inspiration from its primitives.
